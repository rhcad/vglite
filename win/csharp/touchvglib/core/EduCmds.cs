...
public class EduCmds : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal EduCmds(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(EduCmds obj) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          touchvgcsPINVOKE.delete_EduCmds(swigCPtr);
        }
  ...
  public EduCmds() : this(touchvgcsPINVOKE.new_EduCmds(), true) {
  }
